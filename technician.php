		...
		<main>
			...
			<section class="grid">
				<div class="card">
					...
					<p>Placeholder summary of today's tickets, machine bookings, and safety holds.</p>
				</div>
				<div class="card">
					<h2>Checklist Queue</h2>
					<p>Future list of required inspections, calibrations, and close-out steps.</p>
				</div>
				<div class="card">
					<h2>Knowledge Base</h2>
					<p>Reserved for SOP shortcuts, troubleshooting tips, and quick training clips.</p>
				</div>
			</section>
